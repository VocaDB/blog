...
Currently, the database contains over **137 100** artist entries, over **35 300** album entries, over **826 900** song entries, over **8 500** event entries and over **5 200** tag entries. As of now, VocaDB counts over **21 600** registered users.
...
- Addition of a new background theme
- Addition of the new artist type “Band/unit”
- Better and faster image hosting
- Image previews on all edit pages
- Updates to the infrastructure and database
- Various bug fixes
...
Thank you for reading! We wish you a wonderful year 2026!
